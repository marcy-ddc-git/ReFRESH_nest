...
/****** Object:  Table [dbo].[tb_AG_refresh_group]    Script Date: 2/6/2022 7:00:37 PM ******/
SET ANSI_NULLS ON
GO
...
--next build in Primary key, so get temp table data and then recreate table
select * into tb_AG_refresh_group_temp_addPK from tb_AG_refresh_group ;
select * from tb_AG_refresh_group_temp_addPK  ;
